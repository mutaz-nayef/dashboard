<x-system-layout>
    ...
    <!--begin::Link-->
    <div class="mb-11">
        <a href="../../demo1/dist/authentication/layouts/corporate/sign-in.html" class="btn btn-sm btn-primary">Sign
            in</a>
    </div>
    <!--end::Link-->
    <!--begin::Illustration-->
    <div class="mb-0">
        <img src="{{asset('admin')}}/assets/media/auth/ok.png" class="mw-100 mh-300px theme-light-show" alt="">
        <img src="{{asset('admin')}}/assets/media/auth/ok-dark.png" class="mw-100 mh-300px theme-dark-show" alt="">
    </div>
    <!--end::Illustration-->
