        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <x-header.nav-item title="Dashboards" trigger="{default: 'click', lg: 'hover'}"
                        placement="bottom-start" />
                    <x-header.nav-item title="Pages" trigger="{default: 'click', lg: 'hover'}"
                        placement="bottom-start" />
                    <x-header.nav-item title="Apps" trigger="{default: 'click', lg: 'hover'}"
                        placement="bottom-start" />

                    <x-header.nav-item title="Layouts" trigger="{default: 'click', lg: 'hover'}"
                        placement="bottom-start" />
            ...
            <div class="app-navbar flex-shrink-0">
                                ...
                                <div data-kt-search-element="results" class="d-none">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('admin') }}/assets/media/avatars/300-11.jpg"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('admin') }}/assets/media/svg/brand-logos/tvit.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('admin') }}/assets/media/svg/misc/infography.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('admin') }}/assets/media/svg/brand-logos/leaf.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('admin') }}/assets/media/svg/brand-logos/tower.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                ...
                {{-- @include('components.header.activities.activities') --}}
                ...
                {{-- @include('components.header.chat.chat') --}}

                <!--end::Chat-->
                <!--begin::My apps links-->

                {{-- @include('components.header.app-links') --}}
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <img src="{{ asset('admin') }}/assets/media/avatars/300-3.jpg" class="rounded-3" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('admin') }}/assets/media/avatars/300-3.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                            ...
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">Language
                                    <span
                                        ...
                                        {{app()->getLocale() === 'ar' ? 'العربية' : 'Engilsh'}}
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="{{ asset('admin') }}/assets/media/flags/{{app()->getLocale() === 'ar' ? 'saudi-arabia.svg' : 'united-states.svg'}}"
                                            alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('set-locale', $locale) }}"
                                        ...
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('admin/assets/media/flags/' . $flag) }}"
                                                alt="{{ $locale }} flag" />
                                        </span>
                                        {{ $locale === 'en' ? __('English') : __('العربية') }}
                                    </a>
                                </div>
                                @endforeach
